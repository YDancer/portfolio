    ...
    return(
        <div className="bottomButtons">
            ...
            <div className={props.moreRole ? "bottomButton invertArrow arrowButton" : "bottomButton arrowButton"} onClick={props.roleHandler}>
                ...
                <h3>{props.solo ? "Additional Information" : "My role"}</h3>
            </div>
            {(props.links != null) && <div className={props.extLinks ? "bottomButton invertArrow arrowButton" : "bottomButton arrowButton"} onClick={props.linkHandler}>
